...
import nl.zerofiftyit.model.ExecutionMap;
...
public final class PomAnalyzer extends DefaultAnalyzer {
     ...
     * @param allElements a list of {@code PomElement} objects representing POM nodes for analysis
     ...
     * @param errorMessages a list of error messages for recording validation errors during analysis
     */
    public PomAnalyzer(final String givenNode, final List<PomElement> allElements,
                       final ResultCaller resultCaller, final NegateNext negateNext,
                       final List<String> errorMessages) {
        super(givenNode, allElements, resultCaller, negateNext, errorMessages);
     ...
     *         for the analysis.
     */
    public ResultCaller havePluginExecutionInPhaseForGoal(final String pluginArtifactId,
                                                          final String phase, final String goal) {
        List<Object> plugins = allElements.stream()
     ...
     */
    public ResultCaller haveProperty(final String propertyName) {
        List<PomElement> properties = allElements.stream()
